            ...
            require('telescope').setup {
              ...
              --   defaults = {
                ...
                },
                {
                  ...
                  -- All config moved to lua/custom/plugins/lsp.lua
                  'neovim/nvim-lspconfig',
                  config = function()
                    -- All LSP config is in lua/custom/plugins/lsp.lua
                  end,
                },
                  ...
                  dependencies = {
                    ...
                    { -- Collection of various small independent plugins/modules
                      ...
                      config = function()
                        ...
                        "volar"   statusline.section_location = function()
                          return '%2l:%-2v'
                        end
